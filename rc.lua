...
-- awful.spawn.with_shell ("conky", 'conky | while read line; do echo -e "conky_widget:set_text(\'$line\')" | awesome-client; done')
--run_once("conky", 'conky | while read line; do echo -e "conky_widget:set_text(\'$line\')" | awesome-client; done')
...
awful.key({ modkey, "Shift" }, "m", function (c) c.maximized = false
